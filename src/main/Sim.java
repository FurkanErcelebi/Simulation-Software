...
public class Sim {
    ...
    public static void ReportGeneration() {
        ...
        System.out.println( "\tSTANDARD DEVIATION OF SERVICE STANDARD DEVIATION OF SERVICE TIMES E TIMES "
                + SIGMA);
        ...
        System.out.println("\tMAXIMUM LINE LENGTH tMAXIMUM LINE LENGTH " + MaxQueueLength );
